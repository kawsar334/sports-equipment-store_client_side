    ...
    return (
        <div className="w-full max-w-md mx-auto mt-16 p-8 bg-transparent   md:border  shadow-md rounded-lg">
            ...
            <button
                ...
                className="w-full my-4 text-red-500 bg-white border-red-500 border-[1px] py-2 rounded-[20px]  hover:text-white hover:border hover:bg-blue transition duration-200"
            >
                Singin with google
            </button>
