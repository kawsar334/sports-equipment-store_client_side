        ...
        <div className="flex justify-center items-center h-screen bg-transparent">
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl  md:border   shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full px-4 py-2  border   rounded-md  focus:outline-none focus:ring focus:ring-blue focus:rounded   bg-transparent  hover:bg-blue hover:text-white"
                    >
                        Register
                    </button>
                </form>
